...
public class FavoriteService {
    ...
    public void saveOrDelete(Favorite favorite, boolean isLike) {
        ...
        ArrayList<Favorite> oldFavorites = favoriteDao.getFavoriteByUserIdAndTopicId(userId, topicId);
        boolean hasOldFavorite = oldFavorites.size() > 0;
        if (hasOldFavorite) {
            for (Favorite oldFavorite : oldFavorites) {
